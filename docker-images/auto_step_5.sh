...
docker build --tag res/apache_reverse_proxy --file ./apache-reverse-proxy/Dockerfile ./apache-reverse-proxy/
...
docker run -d --name apache_reverse_proxy -e STATIC_APP=172.17.0.2:80 -e DYNAMIC_APP=172.17.0.3:3000 -p 8080:80 res/apache_reverse_proxy
